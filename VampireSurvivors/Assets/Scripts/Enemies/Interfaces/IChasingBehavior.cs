...
public interface IChasingBehavior
{
...
public class SpiralChasing : IChasingBehavior
{
    [Header("Spiral Chasing Settings")]
    [SerializeField]
    ...
    {
        spiralMovementSettings.SpiralTightnessRange = ((SpiralChasingSettingsData)settings).SpiralTightnessRange;
        spiralMovementSettings.SpiralRadiusIncreaseTime = ((SpiralChasingSettingsData)settings).SpiralRadiusIncreaseTime;
    }
...
public class WaveChasing : IChasingBehavior
{
    [Header("Wave Chasing Settings")]
    [SerializeField]
    ...
    public void Initialize(ScriptableObject settings)
    {
        waveMovementSettings.WaveAmplitudeRange = ((WaveChasingSettingsData)settings).WaveAmplitudeRange;
        waveMovementSettings.WaveFrequency = ((WaveChasingSettingsData)settings).WaveFrequency;
        waveMovementSettings.AngleRange = ((WaveChasingSettingsData)settings).AngleRange;
    }
...
public class CircleChasing : IChasingBehavior
{
    [Header("Circle Chasing Settings")]
    [SerializeField]
    ...
    public void Initialize(ScriptableObject settings)
    {
        circleMovementSettings.CircleRadius = ((CircleChasingSettingsData)settings).CircleRadius;
    }
...
public class StraightChasing : IChasingBehavior
{
    public void Initialize(ScriptableObject settings)
    {
